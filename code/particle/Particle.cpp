...
Particle::Particle(std::vector<ParticleType*> particle_v, std::string name, P p, int i) : fParticleType{particle_v}, fName{name}, fP{p}, fIParticle{i} {
